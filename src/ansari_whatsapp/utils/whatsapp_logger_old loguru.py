...
"""Logging configuration for the WhatsApp service."""
...
def get_logger(name: str) -> logging.Logger:
    ...
    try:
        ...
        dev_mode = settings.DEV_MODE if hasattr(settings, "DEV_MODE") else True
    except Exception:
        logging_level = "INFO"
        dev_mode = True
    ...
    rich_handler = RichHandler(
        console=console,
        enable_link_path=dev_mode,  # Enable VS Code clickable links in DEV_MODE
        markup=True,
